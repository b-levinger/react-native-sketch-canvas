...
//		let path
//		
//		console.log("building createResponder")
//	
...
//
//	useEffect(() => {
//		console.log("CB changed", [touchEnabled, user, strokeColor, handle, strokeWidth, strokeColor, onStrokeStart, onStrokeEnd, onStrokeChanged])
